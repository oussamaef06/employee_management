                        ...
                        <form id="addUserForm" role="form">
                            <div class="box-body">
                                ...
                                <div class="form-group">
                                    ...
                                    <input type="password" class="form-control" id="mot_de_passe" name="mot_de_passe" placeholder="Enter Password">
                                </div>
                            ...
                            <div class="box-footer">
                                ...
                                <a href="<?= base_url('index.php/utilisateurs/index') ?>" class="btn btn-default">Cancel</a>
                            </div>
                        </form>
                    </div>
                </div>
...
$(document).ready(function() {
    $('#addUserForm').on('submit', function(e) {
        ...
        $.ajax({
            url: '<?= base_url('index.php/utilisateurs/add') ?>',
            type: 'POST',
            data: $(this).serialize(),
            dataType: 'json',
